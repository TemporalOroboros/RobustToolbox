...
namespace Robust.Shared.GameObjects
{
            ...
            ILogManager logManager) : IComponentFactory
    {
            ...
            bool overwrite = false)
        {
            ...
            var doNotPrototype = type.HasCustomAttribute<DoNotPrototypeComponentAttribute>();

            var registration = new ComponentRegistration(name, type, idx, unsaved, doNotPrototype);
